-- Migration: Create app discovery platform tables
-- Created: 2025-10-21
...
-- ALTER TABLE itunes_apps ENABLE ROW LEVEL SECURITY;
-- ALTER TABLE apple_rss_apps ENABLE ROW LEVEL SECURITY;
-- ALTER TABLE serp_apps ENABLE ROW LEVEL SECURITY;
-- ALTER TABLE apps_unified ENABLE ROW LEVEL SECURITY;

-- Grant permissions (adjust as needed)
-- GRANT ALL ON itunes_apps TO authenticated;
-- GRANT ALL ON apple_rss_apps TO authenticated;
-- GRANT ALL ON serp_apps TO authenticated;
-- GRANT ALL ON apps_unified TO authenticated;
