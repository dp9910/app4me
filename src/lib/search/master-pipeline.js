...
// Environment variables are handled by Next.js in production
...
class ProgressTracker extends EventEmitter {
  ...
  updateStep(stepId, status, data = {}) {
    ...
    if (step) {
      ...
      // File writes disabled in production
      ...
      if (saveIntermediateFiles) {
        if (process.env.NODE_ENV !== 'production') {
          try {
            ...
            console.log('Analysis file write skipped in serverless environment');
          }
        }
      }
      ...
      if (saveIntermediateFiles) {
        if (process.env.NODE_ENV !== 'production') {
          try {
            ...
            console.log('Keywords file write skipped in serverless environment');
          }
        }
      }
      ...
      if (saveIntermediateFiles) {
        if (process.env.NODE_ENV !== 'production') {
          try {
            ...
            console.log('Candidates file write skipped in serverless environment');
          }
        }
      }
      ...
      if (saveIntermediateFiles) {
        if (process.env.NODE_ENV !== 'production') {
          try {
            ...
            console.log('Pipeline results file write skipped in serverless environment');
          }
        }
